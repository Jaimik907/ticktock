...
function validate(form: FormState): FormErrors {
  ...
  if (!form.description.trim()) errors.description = "Task description is required."
  return errors
}

export default function AddEntryModal({ open, entry, onClose, onSubmit }: Props) {
  ...
  useEffect(() => {
    if (entry) {
      ...
      setForm({ project: "", workType: "Bug fixes", description: "", hours: 12 })
    }
    setErrors({})
  }, [entry, open])
